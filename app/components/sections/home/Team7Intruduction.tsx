...
const Team7Intruduction = () => {
    ...
    const paragraphRef5 = useRef<HTMLParagraphElement>(null) ;
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            gsap.set([divRef1.current , divRef2.current , divRef3.current , divRef4.current] , {y : 1000 , height : "100%"}) ;
            ...
            gsap.set([imageRef1.current , imageRef2.current , imageRef3.current , imageRef4.current] , {y : 1000 , opacity : 0}) ;
    ...
    return (
        <div ref={sectionRef} className="h-screen bg-black w-full grid grid-cols-4 gap-14 px-10 relative">
            ...
            <div className="duration-300 col-span-1 ml-0 relative flex w-full">
                ...
                <div className="overflow-hidden h-[93%]">
                    <Image ref={imageRef1} src={narutoImage} width={100} height={100} alt="Naruto Image" unoptimized className="w-fit h-[93%] absolute top-12 left-5" />
                </div>
                
                <div ref={divRef1} className="w-[100%] h-[94%] rounded-lg bg-white/ border border-white/20 backdrop-blur-xs z-10 duration-300 hover:border-yellow-400 hover:blur-none hover:backdrop-blur-none mt-12 flex flex-col items-center justify-end py-10 px-3">
            ...
            <div className="duration-300 col-span-1 relative flex w-full">
                ...
                <div className="">
                    <Image ref={imageRef2} src={sasukeImage} width={100} height={100} alt="Sasuke Image" unoptimized className="w-fit h-[93%] absolute left-16 top-12" />
                </div>
                
                <div ref={divRef2} className="w-[100%] h-[94%] rounded-lg bg-white/ border border-white/20 backdrop-blur-xs z-10 duration-300 hover:border-blue-400 hover:blur-none hover:backdrop-blur-none mt-12 flex flex-col items-center justify-end py-10 px-3">
            ...
            <div className="duration-300 col-span-1 relative flex w-full">
                ...
                <div className="">
                    <Image ref={imageRef3} src={sakuraImage} width={100} height={100} alt="Sakura Image" unoptimized className="w-fit h-[90%] absolute top-14 left-5" />
                </div>
                
                <div ref={divRef3} className="w-[100%] h-[94%] rounded-lg bg-white/ border border-white/20 backdrop-blur-xs z-10 duration-300 hover:border-pink-400 hover:blur-none hover:backdrop-blur-none mt-12 flex flex-col items-center justify-end py-10 px-3">
            ...
            <div className="duration-300 col-span-1 relative flex w-full">
                ...
                <div className="">
                    <Image ref={imageRef4} src={kakashiImage} width={100} height={100} alt="Kakashi Image" unoptimized className="w-fit h-[92%] absolute left-10 top-14" />
                </div>
                
                <div ref={divRef4} className="w-[100%] h-[94%] rounded-lg bg-white/ border border-white/20 backdrop-blur-xs z-10 duration-300 hover:border-gray-300 hover:blur-none hover:backdrop-blur-none mt-12 flex flex-col items-center justify-end py-10 px-3">
                    ...
                    <p className="" ref={paragraphRef5}>  </p>
                </div>
