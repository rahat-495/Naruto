    ...
    return (
        <div ref={sectionRef} className='h-screen w-full overflow-hidden bg-gradient-to-tl from-[#04121e] to-[#0d1e29] relative grid grid-cols-2'>
            ...
            <div ref={leftImageRef} className="">
                <Image src={team7allMemberImage} width={100} height={100} alt="team 7 members image." unoptimized className="w-[85%] h-[95%] mt-12 ml-8"/>
            </div>

            <div ref={rightDivRef} className="text-white px-10 py-20 space-y-6 leading-relaxed font-light text-right">
                <h2 className="text-4xl font-semibold text-white mb-6">Team 7's Formation: Bonds, Tests & Growth</h2>
                ...
                <p className="text-center border-y border-[#f5f3bc] rounded-md text- font-medium text-[#fffdc0] mt-6">
